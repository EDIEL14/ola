            ...
            $id_usuario = isset($_SESSION['id_usuario']) ? $_SESSION['id_usuario'] : null;
                ...
                .carousel-caption h1 {
                    font-size: 3.4rem; /* Tamaño grande para ocupar buena parte de la imagen */
                    font-weight: bold;
                    line-height: 1.2;
                ...
                <body>
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="/imagenes/PRINCIPAL 2.jpeg" class="d-block w-100" alt="Plano Principal 2">
                            <div class="carousel-caption">
                            <h1>PLANOS PARA TU CASA</h1>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="/imagenes/PRINCIPAL 3.jpeg" class="d-block w-100" alt="Plano Principal 3">
                            <div class="carousel-caption">
                            <h1>PLANOS PARA TU CASA</h1>
                            </div>
                        </div>
